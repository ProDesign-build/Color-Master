                ...
                <div className="flex-grow overflow-y-auto p-4 custom-scrollbar">
                     <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
                        ...
                        {filteredSwatches.map(swatch => (
                            <div key={swatch.id} className="flex items-center justify-between p-3 rounded-xl border border-gray-100 bg-white hover:border-gold-500/50 hover:shadow-md transition-all group duration-300">
                ...
                <div className="flex-grow overflow-y-auto p-4 custom-scrollbar">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        {filteredFormulas.map(formula => (
                            <div key={formula.id} className="p-5 rounded-xl border border-gray-100 bg-white hover:border-navy-200 hover:shadow-md transition-all group duration-300 flex flex-col h-full">
